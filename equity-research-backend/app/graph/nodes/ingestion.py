...
from app.connectors.alpha_vantage_client import fetch_alpha_vantage_fundamentals
    ...
    def get_fundamentals_with_fallback(ticker_sym):
        try:
            ...
            if fund.market_cap is None:
                raise ValueError("yfinance returned empty fundamentals (market_cap is None)")
            return fund
