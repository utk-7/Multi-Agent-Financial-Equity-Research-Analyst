...
class SentimentResult(BaseModel):
    ...
    rationale: str = Field(
        ..., description="A short paragraph explaining the score based on the headlines"
    )
    supporting_headlines: List[str] = Field(
        ..., description="List of headlines that were analyzed"
    )
    call_succeeded: bool = Field(
        True, description="True if the LLM call was successful, False otherwise"
    )
